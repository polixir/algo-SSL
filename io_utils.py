...
import argparse
import backbone
import HRNet_config.HRNet as HRNet
...
def parse_args(script):
    ...
    if script == 'train':
        ...
        parser.add_argument('--stop_epoch'  , default=200, type=int, help ='Stopping epoch') # for meta-learning methods, each epoch contains 100 episodes
...
def get_resume_file(checkpoint_dir):
    ...
    resume_file = os.path.join(checkpoint_dir, '120.tar')
    return resume_file
