...
class SSL_Finetune(MetaTemplate):
    def __init__(self, model_func, n_way, n_support):
        super(SSL_Finetune, self).__init__(model_func, n_way, n_support)
    ...
    def set_forward_adaptation(self, x, is_feature=True):
        ...
        linear_clf = backbone.SSL_Linear(self.feat_dim[0], self.n_way)
        ...
        for epoch in range(100):
            ...
            for i in range(0, support_size, batch_size):
                ...
                loss.backward()
                set_optimizer.step()
        scores = linear_clf(z_query,torch.zeros(1))
        return scores
