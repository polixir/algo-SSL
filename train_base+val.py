# -*- encoding: utf-8 -*-
'''
File    :   train_base+val.py
Time    :   2020/03/10 19:34:33
Author  :   Chao Wang 
Version :   1.0
...
if __name__=='__main__':
    ...
    base_val_file = configs.data_dir[params.dataset] + 'base+val.json'
    ...
    if params.method in ['baseline', 'baseline_dist'] :
        ...
        base_val_datamgr = SimpleDataManager(image_size, batch_size = 200)
        base_val_loader = base_val_datamgr.get_data_loader( base_val_file , aug = params.train_aug )
        val_datamgr = SimpleDataManager(image_size, batch_size = 64)
        val_loader = val_datamgr.get_data_loader( val_file, aug = False)
    ...
    model = train(base_val_loader, val_loader,  model, optimization, start_epoch, stop_epoch, params)
